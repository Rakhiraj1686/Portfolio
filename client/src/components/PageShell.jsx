...
const shellBackground = {
  // background:
  //   "radial-gradient(circle at top left, rgba(216, 164, 255, 0.18), transparent 28%), radial-gradient(circle at bottom right, rgba(244, 114, 182, 0.16), transparent 32%), linear-gradient(135deg, rgba(255, 240, 245, 0.8) 0%, rgba(250, 200, 230, 0.7) 42%, rgba(240, 180, 220, 0.6) 100%)",
