...
const projects = [
  {
    ...
    tech: ["React", "Node.js", "MongoDB", "Express", "TailwindCSS", "JWT", "REST API"],
  ...
  },
  {
    ...
    github: "https://github.com/Rakhiraj1686/RICR-Web-Development/tree/main/Craving",
    live: "#",
  },
  {
    title: "DostiHUB",
    ...
    tech: ["React", "Node.js", "MongoDB", "Socket.io", "Express", "JWT", "REST API", "FlyconUI"],
...
const process = [
  { icon: FiSearch, title: "Research", description: "Understanding the problem, users and requirements deeply." },
  { icon: FiPenTool, title: "Design", description: "Wireframing and structuring a clean, intuitive interface." },
  { icon: FiCode, title: "Development", description: "Writing scalable, maintainable full-stack code." },
  { icon: FiUploadCloud, title: "Deployment", description: "Shipping, testing and iterating in production." },
];

/* ================= ANIMATED COUNTER (plain JS, no framer-motion) ================= */
...
/* ================= PROJECT CARD (CSS-only tilt + spotlight) ================= */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(280px circle at ${glow.x}% ${glow.y}%, rgba(216,164,255,0.12), transparent 70%)`,
        }}
      />
      ...
      <div className="relative flex flex-col gap-4 p-6">
        <div className="flex items-center justify-between">
          <h3 className="text-xl font-semibold text-pink-50">{project.title}</h3>
          <span className="text-xs text-pink-100/65">{project.date}</span>
        </div>

        <p className="text-sm leading-relaxed text-pink-100/78">{project.desc}</p>
  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden px-6 pb-16 pt-15 text-(--color-text) md:px-12">
        ...
        {/* Project Grid */}
        <div className="mx-auto grid max-w-6xl gap-8 mt-16 md:grid-cols-2 lg:grid-cols-3">
            ...
            {process.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-5 text-pink-100/70">{step.description}</p>
                </div>
              );
            })}
          </div>
