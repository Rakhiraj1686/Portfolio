...
// import hackathonNK from "../assets/hackathon.jpeg";
...
import hackathon  from "../assets/data/hackathon";
import HackathonCard from "../components/HackathonCasrd";
import { motion } from "framer-motion";

const Hackathons = () => {
  return (
    <>
      <section className="relative min-h-screen overflow-hidden px-6 py-16 text-white">

        {/* Background */}

        <div className="absolute inset-0 -z-10">
          {/* <div className="absolute left-0 top-0 h-96 w-96 rounded-full bg-pink-500/10 blur-[170px]" /> */}
          <div className="absolute bottom-0 right-0 h-112 w-md rounded-full bg-purple-600/10 blur-[180px]" />
        </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-3xl leading-8 text-white/70">
              Every hackathon challenged me to think faster,
              collaborate better and transform ideas into
              working products within limited time.
            </p>
          </motion.div>

          {/* Divider */}

          <div className="mx-auto mt-8 h-px w-32 bg-linear-to-r from-transparent via-purple-300 to-pink-400" />
      ...
      <footer className="border-t border-white/10 bg-white/5 py-1 backdrop-blur-sm">
